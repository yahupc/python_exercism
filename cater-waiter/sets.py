...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    return (drink_name + (" Cocktail" if set(drink_ingredients) & ALCOHOLS else " Mocktail"))
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    no_appetizers = set(dishes).difference(appetizers)
    return list(set(no_appetizers)) 
