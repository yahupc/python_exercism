...
def value_of_ace(card_one, card_two):
    ...
    if card_one == "A" or card_two == "A":
        ...
        card_1 = value_of_card(card_one)
        card_2 = value_of_card(card_two)
        option_1 = 21 - (1 + card_1 + card_2)
        option_2 = 21 - (11 + card_1 + card_2)
...
def is_blackjack(card_one, card_two):
    ...
    if (card_one == "A" and ((card_two in face_cards) or card_2 == 10)) or (
        ((card_one in face_cards) or card_1 == 10) and card_two == "A"
    ):
        return True
    else:
        return False
